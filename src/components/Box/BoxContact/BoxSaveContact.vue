<template>
    <div class="box-contact">
        <h1 class="text-phone">Danh Sách Danh Bạ</h1>
        <div class="search">
            <input type="text" id="search" class="search-input" v-model="search" placeholder="search name"/>
            <el-icon class="icons"><Search /></el-icon>
        </div>
        <p v-if="isLoading" class="text">loading.....</p>
        <el-table :data="filteredSearch" style="width: 100%">
